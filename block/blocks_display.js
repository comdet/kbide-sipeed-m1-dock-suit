...
module.exports = function (Blockly) {
  ...
  Blockly.Blocks['tft_display_init'] = {
    init: function() {
      this.appendDummyInput()
          .appendField("ST7789 Display begin, size")
          .appendField(new Blockly.FieldNumber(320, 1, 99999), "width")
          .appendField("x")
          .appendField(new Blockly.FieldNumber(240, 1, 99999), "height")
          .appendField("with color")
          .appendField(new Blockly.FieldColour("#ff0000"), "color");
      this.setPreviousStatement(true, null);
      this.setNextStatement(true, null);
      this.setColour(230);
   this.setTooltip("initial display");
   this.setHelpUrl("");
    }
  };
  ...
  Blockly.Blocks["i2c128x64_display_image"] = {
    init: function () {
      this.appendValueInput("img")
        ...
        .setCheck(["std::vector<uint16_t>","uint16_t *"])
